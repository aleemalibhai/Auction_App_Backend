...
class User {
    public:
        ...
        virtual std::string bid(std::string itemName, std::string buyerName, float price) {};
        virtual std::string refund(std::string sellerName, std::string buyerName, float credit){};
        virtual std::string addCredit(std::string username, float credit){};
        virtual std::string advertise(std::string username, float price, int days){};
...
class Admin: public User {
    public:
        ...
        */
        std::string create(std::string username, std::string userType, float credit); 
        ...
        */
        ...
        /*
            ...
            Output: Returns a formatted string to write to daily transaction file
        */
        std::string bid(std::string itemName, std::string sellerName, float price);
        ...
        */
        ...
        /*
            ...
            Output: Returns a formatted string to write to daily transaction file
        */
        std::string addCredit(std::string username, float credit);
    ...
    public: 
        ...
        */
        ...
        /*
            ...
            Output: Returns a formatted string to write to daily transaction file
        */
        std::string bid(std::string itemName, std::string buyerName, float price);          
        ...
        /*
            ...
            Output: Returns a formatted string to write to daily transaction file
        */
        std::string addCredit(float credit);          
